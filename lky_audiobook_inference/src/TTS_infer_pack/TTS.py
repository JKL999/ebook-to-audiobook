...
# from BigVGAN.bigvgan import BigVGAN  # Not needed for LKY inference
...
class TTS_Config:
    default_configs = {
        ...
        "v2": {
            ...
            "is_half": False,
            "version": "v2",
            "t2s_weights_path": "/home/tim/Projects/ebook-to-audiobook/GPT-SoVITS/GPT_SoVITS/logs/lky_en_cli/s1_train/ckpt/epoch=19-step=220.ckpt",
            "vits_weights_path": "/home/tim/Projects/ebook-to-audiobook/GPT-SoVITS/logs/lky_en_cli/logs_s2_v2/G_233333333333.pth",
            "cnhuhbert_base_path": "/home/tim/Projects/ebook-to-audiobook/GPT-SoVITS/pretrained_models/chinese-hubert-base",
            "bert_base_path": "/home/tim/Projects/ebook-to-audiobook/GPT-SoVITS/pretrained_models/chinese-roberta-wwm-ext-large",
        },
        "v3": {
            "device": "cpu",
            "is_half": False,
...
class TTS:
    ...
    def init_t2s_weights(self, weights_path: str):
        ...
        if "hyper_parameters" in dict_s1 and "config" in dict_s1["hyper_parameters"]:
            config = dict_s1["hyper_parameters"]["config"]
        else:
            config = dict_s1["config"]  # fallback for other formats
        self.configs.max_sec = config["data"]["max_sec"]
        t2s_model = Text2SemanticLightningModule(config, "****", is_train=False)
        # Handle PyTorch Lightning state_dict format
        if "state_dict" in dict_s1:
            t2s_model.load_state_dict(dict_s1["state_dict"])
        else:
            t2s_model.load_state_dict(dict_s1["weight"])  # fallback
    ...
    def init_vocoder(self, version: str):
        if version == "v3":
            # BigVGAN vocoder commented out - not needed for LKY inference
            pass
